...
class PriceTierAnalyzerTest {
    ...
    void congestedUsesMempoolThresholds() {
        ...
        // fee > fast -> CHEAP
        var res1 = new PriceTierAnalyzer(1000).analyze(base.toBuilder()
                .newTransaction(new com.blockchain.blockpulseservice.model.domain.Transaction("t1", new BigDecimal("60"), BigDecimal.ZERO, 100, Instant.EPOCH))
        ...
        var res2 = new PriceTierAnalyzer(1000).analyze(base.toBuilder()
                .newTransaction(new com.blockchain.blockpulseservice.model.domain.Transaction("t2", new BigDecimal("25"), BigDecimal.ZERO, 100, Instant.EPOCH))
                .mempoolStats(new MempoolStats(50, 25, 10, 2000))
                .build());
        ...
        var res3 = new PriceTierAnalyzer(1000).analyze(base.toBuilder()
                .newTransaction(new com.blockchain.blockpulseservice.model.domain.Transaction("t3", new BigDecimal("40"), BigDecimal.ZERO, 100, Instant.EPOCH))
                .mempoolStats(new MempoolStats(50, 25, 10, 2000))
                .build());
    ...
    void notCongestedUsesIqr() {
        ...
        var r1 = priceTierAnalyzer.analyze(base.toBuilder()
                .newTransaction(new com.blockchain.blockpulseservice.model.domain.Transaction("t1", new BigDecimal("9.99"), BigDecimal.ZERO, 100, Instant.EPOCH))
                .build());
        assertEquals(PriceTier.CHEAP, r1.getPriceTier());

        // inside -> NORMAL
        var r2 = new PriceTierAnalyzer(1000).analyze(base.toBuilder()
                .newTransaction(new com.blockchain.blockpulseservice.model.domain.Transaction("t2", new BigDecimal("15"), BigDecimal.ZERO, 100, Instant.EPOCH))
                .build());
        assertEquals(PriceTier.NORMAL, r2.getPriceTier());

        // above -> EXPENSIVE
        var r3 = new PriceTierAnalyzer(1000).analyze(base.toBuilder()
                .newTransaction(new com.blockchain.blockpulseservice.model.domain.Transaction("t3", new BigDecimal("25"), BigDecimal.ZERO, 100, Instant.EPOCH))
                .build());
