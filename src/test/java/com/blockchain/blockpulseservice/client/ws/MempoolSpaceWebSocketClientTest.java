...
class MempoolSpaceWebSocketClientTest {
    ...
    void doesNothingWhenAlreadyConnected() {
        ...
        mempoolSpaceWebSocketClient.connect();
    ...
    @Test
    void handleTransportError_marksDisconnected_andSchedulesReconnect() {
    ...
    @Test
    void disconnect_cancelsReconnect_closesSession_andMarksDisconnected() {
        mempoolSpaceWebSocketClient.disconnect();
